      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="fade-in-up space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/20 border border-primary/40 rounded-full backdrop-blur-sm">
              <Zap className="w-4 h-4 text-white animate-pulse" />
              <span className="text-xs font-bold text-white uppercase tracking-widest" style={{ fontFamily: 'Orbitron, sans-serif' }}>
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-7xl text-white leading-tight tracking-tighter" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                GLOBAL <span className="text-primary drop-shadow-[0_0_15px_rgba(0,85,255,0.5)]">VOIP</span> SOLUTIONS
              </h1>
              <p className="text-lg text-slate-100 max-w-xl leading-relaxed font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-5 pt-4">
              ...
              <Button
                variant="outline"
                className="border-2 border-white/30 text-white hover:bg-white/10 h-14 px-8 uppercase tracking-wider text-sm backdrop-blur-sm"
            ...
            <div className="grid grid-cols-3 gap-8 pt-10 border-t border-white/20">
              <div>
                <div className="text-3xl font-bold text-white" style={{ fontFamily: 'Orbitron, sans-serif' }}>10+</div>
                <div className="text-[10px] uppercase tracking-widest text-slate-300 mt-1" style={{ fontFamily: 'Orbitron, sans-serif' }}>Years Tech</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white" style={{ fontFamily: 'Orbitron, sans-serif' }}>190+</div>
                <div className="text-[10px] uppercase tracking-widest text-slate-300 mt-1" style={{ fontFamily: 'Orbitron, sans-serif' }}>Nodes</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white" style={{ fontFamily: 'Orbitron, sans-serif' }}>99.9%</div>
                <div className="text-[10px] uppercase tracking-widest text-slate-300 mt-1" style={{ fontFamily: 'Orbitron, sans-serif' }}>Uptime</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="relative rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(0,85,255,0.2)] border border-primary/20">
